...
namespace Client
{
    sealed class DestroyTrailFromTailSystem : MainEcsSystem
    {
        readonly EcsFilterInject<Inc<DestroyTrailFromTailComponent,TrailComponent>> _filter;
        readonly EcsPoolInject<DestroyTrailFromTailComponent> _destroyTrailPool;
        readonly EcsPoolInject<TrailComponent> _trailPool;

        public override MainEcsSystem Clone()
        {
            return new DestroyTrailFromTailSystem();
        }
        ...
        public override void Run(IEcsSystems systems)
        {
            foreach(var entity in _filter.Value)
            {
                ...
                if (trailComp.listBounds.Count > 0)
                    trailComp.listBounds.RemoveAt(0);
            }
        }
        // NE YBIRAY BLAT !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
